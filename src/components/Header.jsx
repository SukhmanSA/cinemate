...
export const Header = () =>{
    const activeClass = "text-base block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-white dark:hover:text-white"
    const inactiveClass = "text-base block py-2 px-3 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-slate-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 " 
    ...
    <header className="bg-white dark:bg-gray-900">
        <nav className="bg-white dark:border-b-slate-500 border-gray-200 mx-10 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to="/" className="l flex items-center space-x-3 rtl:space-x-reverse">
            <img src={logo} className="3 h-11" alt="Flowbite Logo" />
            <span className="text-2xl font-semibold whitespace-nowrap dark:text-white">Cinemate</span>
        </Link>
        <div className="s flex md:order-2">
        <button onClick={()=> setDarkMode(!darkMode)} data-tooltip-target="navbar-search-example-toggle-dark-mode-tooltip" type="button" data-toggle-dark="light" className="flex items-center p-2 mr-2 text-xs font-medium text-gray-700 bg-white rounded-lg border border-gray-200 toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
            ...
            <ul className="flex font-semibold flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                ...
                <li>
                <NavLink to="/movies/upcoming" className={({isActive})=> isActive?activeClass:inactiveClass} aria-current="page">Upcoming</NavLink>
                </li>
            </ul>
            </div>
        </div>
...
/* <header className="header">
  ...
  <div className="navbar-container">
    ...
    <div className={`menu ${hidden ? "hidden" : ""}`} id="navbar-search">
      <ul className="menu-list">
        ...
        <li>
          <NavLink to="/movies/popular" className="menu-item">
            Popular
          </NavLink>
        </li>
        <li>
          <NavLink to="/movies/top" className="menu-item">
            Top Rated
          </NavLink>
        </li>
        <li>
          <NavLink to="/movies/upcoming" className="menu-item">
            Upcoming
          </NavLink>
        </li>
      </ul>
